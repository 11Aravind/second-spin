...
export const Categorydetails = () => {
  ...
  const actionBodyTemplate = (rowData) => {
    return (
      <>
        {subCategorys.find(cat => cat.category_id === rowData._id) !== undefined 
          ? "This added in Subcategory" 
    ...
    <div className={visibility ? "flat-container" : "content-div"}>
      ...
      {/* <div className="content-div"> */}
        ...
        >
          ...
          <Column field="vechicle" header="Vehicle" sortable></Column>
          <Column field="partsName" header="Parts Name" sortable></Column>
          <Column field="spairPatsType" header="Spare Parts Type" sortable></Column>
          <Column header="Image" body={row => <img src={`http://localhost:5001/${row.image}`} alt="banner" className="bannerImg" />} />
